...
## v5.0.7 (2026-09-05) — 고시번호 현행화 (MIN 지시 · 관리허브 VER-1.3 잔여 ②)
| 항목 | 기존 | 변경 |
|---|---|---|
| 근거 고시 표기 13곳(헤더 eyebrow·우측 근거·A4 근거·계산식 안내·법령 근거·카드 배지·푸터) | 국토교통부고시 제2025-738호 | **제2026-360호(실체개정 제2025-738호)** — 2026-07-08 시행(정부조직 개편 반영) · 실체개정 2025-12-31 |
| 별표1 U값·지역 구분·계산 로직 | — | 무변경(고시 실체 동일) |
| sw.js | uval-v5.0.6 | uval-v5.0.7 |
